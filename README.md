...
# 📊 해외여행 증가 추세 분석 보고서
최근 언론 보도에 따르면 해외여행을 필수로 여기는 Z세대가 빠르게 증가하고 있으며, 실제 통계 데이터를 기반으로 해외여행 수요가 늘어나고 있는지를 검증하고자 시각화 분석을 진행하였다. 그 결과, 전반적인 해외여행 증가 추세가 명확하게 확인되었습니다.


## 1. 해외여행 수요의 장기적 변화
> <img width="558" height="464" alt="스크린샷 2025-11-20 오후 3 49 59" src="https://github.com/user-attachments/assets/39975d4e-2b07-4ffa-bd1d-6bb32747964b" />
...
| **기타**        | Git, GitHub, Slack, Postman, Sourcetree, CloudFlare |
| **테스트**      | JUnit5 |
